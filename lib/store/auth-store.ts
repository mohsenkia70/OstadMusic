    ...
    (set, get) => ({
      ...
      login: async (emailOrPhone, password) => {
        ...
        try {
          ...
          const message = err instanceof ApiError ? err.message : "ورود ناموفق بود. دوباره تلاش کن.";
          set({ isLoading: false, error: message, user: null, accessToken: null, expiresAtUtc: null });
          throw err;
        }
      },

      logout: () => {
        set({ user: null, accessToken: null, expiresAtUtc: null, error: null });
      },
